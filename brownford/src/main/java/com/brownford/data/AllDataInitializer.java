    ...
    public void run(String... args) {
        ...
        if (curriculumRepository.count() == 0) {
            ...
            if (p1 != null) {
                ...
                c1.setStatus(Curriculum.Status.ACTIVE);
                curriculums.add(c1);
            }
            if (p2 != null) {
                ...
                c2.setStatus(Curriculum.Status.ACTIVE);
                curriculums.add(c2);
            }
            if (p3 != null) {
                ...
                c3.setStatus(Curriculum.Status.ACTIVE);
                curriculums.add(c3);
            }
            if (p4 != null) {
                ...
                c4.setStatus(Curriculum.Status.ACTIVE);
                curriculums.add(c4);
            }
            if (p5 != null) {
                ...
                c5.setStatus(Curriculum.Status.ACTIVE);
                curriculums.add(c5);
            }
