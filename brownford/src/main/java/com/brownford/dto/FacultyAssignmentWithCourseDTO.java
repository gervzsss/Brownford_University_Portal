...
public class FacultyAssignmentWithCourseDTO {
    ...
    public Long getCurriculumCourseId() {
        return curriculumCourseId;
    }

    public void setCurriculumCourseId(Long curriculumCourseId) {
    ...
    public int getCourseYearLevel() {
        return courseYearLevel;
    }

    public void setCourseYearLevel(int courseYearLevel) {
