...
public interface ScheduleRepository extends JpaRepository<Schedule, Long> {
    ...
    List<Schedule> findConflictsBySection(@Param("section") Section section, @Param("day") String day,
    ...
    List<Schedule> findConflictsByFaculty(@Param("faculty") com.brownford.model.Faculty faculty,
            @Param("day") String day, @Param("startTime") java.time.LocalTime startTime,
            @Param("endTime") java.time.LocalTime endTime, @Param("semester") String semester,
            @Param("schoolYear") String schoolYear);

    // Find schedules for a room that overlap with a given day and time, semester,
    // and school year
    ...
    List<Schedule> findConflictsByRoom(@Param("room") String room, @Param("day") String day,
            @Param("startTime") java.time.LocalTime startTime, @Param("endTime") java.time.LocalTime endTime,
            @Param("semester") String semester, @Param("schoolYear") String schoolYear);
}
